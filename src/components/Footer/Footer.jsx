      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm sm:text-base text-base-content/70 mb-4 sm:mb-6 max-w-md">
              Building the future of web development with modern React Router
              applications. Fast, reliable, and scalable solutions for your
              business needs.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start">
                <svg
                  className="w-5 h-5 mr-3 text-primary mt-1"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
        ...
        <div className="border-t border-base-300 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-base-content/70 text-sm">
              © {new Date().getFullYear()} ReactRouter. All rights reserved.
            </p>
